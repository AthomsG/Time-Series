...
save_residual_plots_as_pdf(residual, "residual_plots_olivais.pdf")
...
save_residual_plots_as_pdf(serie_fit7$residuals, "residual_plots_olivais_fit7.pdf", -0.1, 0.1)
